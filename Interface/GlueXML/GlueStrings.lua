...
ABILITY_INFO_BLOODELF5 = "- Increased expertise with Swords.";
ABILITY_INFO_BLOODELF6 = "- Increased critical chance with Bows.";
...
ABILITY_INFO_DRAENEI5 = "- Increased expertise with Axes.";
...
ABILITY_INFO_GNOME5 = "- Increased expertise with Daggers.";
...
ABILITY_INFO_NIGHTELF5 = "- Increased expertise with Staves, Swords and Polearms.";
ABILITY_INFO_NIGHTELF6 = "- Increased critical chance with Bows.";
...
ABILITY_INFO_SCOURGE5 = "- Increased expertise with Swords and Maces.";
...
ABILITY_INFO_TAUREN5 = "- Increased expertise with Staves, Polearms, Two-Handed Maces, Two-Handed Swords and Two-Handed Axes.";
...
ABILITY_INFO_TROLL6 = "- Increased expertise with Daggers and Axes.";
ACCEPT = "Accept";
...
CHAR_LOGIN_LOCKED_BY_MOBILE_AH = "Your client is out of date. Please use the Game Launcher to update your game, patches, and to install required dependencies. If this error persists contact Server support.";
...
PATCH_FAILED_MESSAGE = "Unable to authentication. Ensure you're logging in with your account's name and not your account's email. Email login is not supported.";
PENETRATION = "PENET %d";
...
REALM_HELP_FRAME_URL = "<a href=\"https://discord.wotlk.com/\">Server Discord</a>";
...
TECH_SUPPORT_URL = "https://discord.wotlk.com";
TEMP_ARMOR = "- Cloth\n- Leather\n- Mail";
