...
PLAYER_SERVER_FIRST_ACHIEVEMENT = "|Hplayer:%s|h[%s]|h has earned the realm first achievement $a!";
...
SERVER_FIRST_ACHIEVEMENT = "%s has earned the realm first achievement $a!";
...
VOLUME = "Volume";
VOTE_BOOT_PLAYER = "A vote has been initiated to remove %1$s from the group.\n\nThe reason given was:\n|cffffd200%2$s|r\n\nDo you want to kick %1$s? Abuse of this feature can lead to account suspensions.";
