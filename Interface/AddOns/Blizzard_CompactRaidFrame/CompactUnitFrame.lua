...
function CompactUnitFrame_UpdateCenterStatusIcon(frame)
    if ( frame.centerStatusIcon ) then
        ...
        elseif ( frame.optionTable.displayIncomingResurrect and UnitHasIncomingResurrection(frame.unit) ) then
            frame.centerStatusIcon.texture:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-Icon-Rez");
...
function CompactUnitFrame_UtilSetDispelDebuff(dispellDebuffFrame, debuffType, index)
    ...
    dispellDebuffFrame.icon:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-Icon-Debuff"..debuffType);
...
function DefaultCompactUnitFrameSetup(frame)
    ...
    frame.background:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-Bar-Hp-Bg");
    ...
    frame.healthBar:SetStatusBarTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-Bar-Hp-Fill", "BORDER");
    ...
    if ( frame.powerBar ) then
        if ( options.displayPowerBar ) then
            ...
            frame.powerBar:SetStatusBarTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-Bar-Resource-Fill", "BORDER");
            frame.powerBar.background:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-Bar-Resource-Background");
            frame.powerBar:Show();
    ...
    frame.myHealAbsorb:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Absorb-Fill", true, true);
    ...
    frame.totalAbsorb:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Shield-Fill");
    frame.totalAbsorb.overlay = frame.totalAbsorbOverlay;
    frame.totalAbsorbOverlay:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Shield-Overlay", true, true);    --Tile both vertically and horizontally
    ...
    frame.overAbsorbGlow:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Shield-Overshield");
    ...
    frame.overHealAbsorbGlow:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Absorb-Overabsorb");
    ...
    frame.ignoreParentAlpha.selectionHighlight:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-FrameHighlights");
    ...
    frame.aggroHighlight:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-FrameHighlights");
    ...
    if ( options.displayBorder ) then
        ...
        frame.horizTopBorder:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-HSeparator");
        ...
        frame.horizBottomBorder:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-HSeparator");
        ...
        frame.vertLeftBorder:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-VSeparator");
        ...
        frame.vertRightBorder:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-VSeparator");
        ...
        if ( options.displayPowerBar ) then
            ...
            frame.horizDivider:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\RaidFrame\\Raid-HSeparator");
