...
hooksecurefunc("UIDropDownMenu_AddButton", function(info, level)
    ...
    if ( not info.notCheckable ) then
        ...
        if ( info.isRadio ) then
            ...
            check:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\COMMON\\UI-DropDownRadioChecks");
            uncheck:SetTexCoord(0.5, 1.0, 0.5, 1.0);
            uncheck:SetTexture("Interface\\AddOns\\Blizzard_CompactRaidFrame\\Media\\COMMON\\UI-DropDownRadioChecks");
        else
